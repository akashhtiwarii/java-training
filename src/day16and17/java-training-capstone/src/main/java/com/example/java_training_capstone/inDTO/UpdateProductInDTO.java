...
/**
 * Data Transfer Object used for updating an existing product.
 * Contains fields such as name, description, price, quantity, and category with validation constraints.
 */
public class UpdateProductInDTO {
    ...
    /**
     * All-args constructor for initializing an UpdateProductInDTO object.
     *
     ...
     */
    public UpdateProductInDTO(String name, String description, BigDecimal price, Integer quantity, String category) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        UpdateProductInDTO that = (UpdateProductInDTO) o;
